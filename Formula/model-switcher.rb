class ModelSwitcher < Formula
  ...
  url "https://github.com/aadarwal/model-switcher/releases/download/v0.3.1/model-switcher-v0.3.1.tar.gz"
  sha256 "8e994b5ed78e5ee7467997e7b1174fb70448f9f636934f60f37a9b1456f0865d"
  version "0.3.1"
  license "MIT"
