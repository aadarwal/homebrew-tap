class ModelSwitcher < Formula
  ...
  url "https://github.com/aadarwal/model-switcher/releases/download/v0.3.4/model-switcher-v0.3.4.tar.gz"
  sha256 "82442673d3d430926827e4aaf4527160606041d7aa79c4eecfb66a3fb542dad7"
  version "0.3.4"
  license "MIT"
