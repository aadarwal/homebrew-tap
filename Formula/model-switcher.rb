class ModelSwitcher < Formula
  ...
  url "https://github.com/aadarwal/model-switcher/releases/download/v0.2.5/model-switcher-v0.2.5.tar.gz"
  sha256 "7b9d69d95386ce70dadb715cd96bb6e1e194ac4b3fdd7e06dfff608d1cd04291"
  version "0.2.5"
  license "MIT"
