class ModelSwitcher < Formula
  ...
  url "https://github.com/aadarwal/model-switcher/releases/download/v0.3.5/model-switcher-v0.3.5.tar.gz"
  sha256 "a1f8ae9d952078aa30bc8def8ab5f8de0b42b821e2a31f0d18e4dc4d6fb1342f"
  version "0.3.5"
  license "MIT"
